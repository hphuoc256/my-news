...
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form id="form" action="{{ route('postDetailService', ['id' => $detail['id']]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
            ...
            <div class="card-body">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <select class="form-control" id="exampleSelectd" name="parent_id">
                            ...
                            @foreach($services as $service)
                                <option value="{{ $service['id'] }}"  @if($detail['parent_id'] == $service['id']){{ "selected" }} @endif>
                                    {{ $service['name'] }}</option>
                                @if ($service->children)
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control" name="price" type="number" value="{{ $detail['price'] }}" placeholder="Enter price">
                        @if($errors->has('price'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control" name="sell" type="number" value="{{ $detail['sell'] }}" placeholder="Enter sell">
                        @if($errors->has('sell'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-form-label">
                        <div class="card card-custom">
                            <textarea name="title" id="title" cols="30" rows="10">{{ $detail['title'] }}</textarea>
                        </div> 
                    </div>
                </div>
                <div class="form-group row">
